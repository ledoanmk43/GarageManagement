...
ALTER TABLE PHIEUTHUTIEN
ADD CONSTRAINT FK_HOSOKHACHHANG_PHIEUTHUTIEN FOREIGN KEY (IDPTT, CARNUMBER) REFERENCES HOSOKHACHHANG(ID, CARNUMBER) ON DELETE CASCADE
ALTER TABLE PHIEUTHUTIEN
ADD CONSTRAINT FK_PHIEUSUACHUA_PHIEUTHUTIEN FOREIGN KEY (IDPTT, CARNUMBER, IDITEM) REFERENCES PHIEUSUACHUA(IDPSC, CARNUMBER, IDITEM) ON DELETE CASCADE
...
ALTER TABLE PASSWORD
ADD CONSTRAINT FK_PASSWORD_STAFF FOREIGN KEY (ID) REFERENCES STAFF(ID) ON DELETE CASCADE
